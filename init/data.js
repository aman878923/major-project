const sampleListings = [
  ...
  },
  {
    ...
    price: 30.0,
    image:
      "https://upload.wikimedia.org/wikipedia/commons/6/6f/Great_Wall_of_China_Jinshanling-edit.jpg",
    location: "Beijing",
    country: "China",
  },
  {
  ...
  },
  {
    ...
    description:
      "An ivory-white marble mausoleum on the southern bank of the river Yamuna in Agra.",
    price: 20.0,
  ...
  {
    title: "See Christ the Redeemer",
    description:
      "An Art Deco statue of Jesus Christ in Rio de Janeiro, Brazil.",
    price: 15.0,
    image:
      "https://upload.wikimedia.org/wikipedia/commons/1/14/Cristo_Redentor_-_Rio_de_Janeiro%2C_Brasil.jpg",
    location: "Rio de Janeiro",
    country: "Brazil",
  },
  {
    title: "Visit the Colosseum",
    description: "An ancient amphitheatre in the centre of the city of Rome.",
    price: 18.0,
    image:
      "https://upload.wikimedia.org/wikipedia/commons/d/d0/Colosseum_in_Rome%2C_Italy_-_April_2007.jpg",
    location: "Rome",
    country: "Italy",
  },
  {
    ...
    description:
      "A beautiful island in the Aegean Sea, famous for its white-washed buildings.",
    price: 10.0,
    image:
      "https://upload.wikimedia.org/wikipedia/commons/c/c4/Santorini_Thira_Bucht.JPG",
    location: "Aegean Sea",
    country: "Greece",
  },
  {
    ...
    price: 50.0,
    image:
      "https://upload.wikimedia.org/wikipedia/commons/9/9e/Al_Khazneh_Petra_edit_2.jpg",
